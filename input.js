...
class AppleStyleView extends ItemView {
  ...
  transformCodeBlocksForClipboard(root) {
    ...
    codeBlocks.forEach((block) => {
      ...
      const codeLinesStyle = codeLinesNode?.getAttribute('style')
        || 'white-space:nowrap !important;display:inline-block !important;min-width:100% !important;word-break:keep-all !important;overflow-wrap:normal !important;line-height:1.75 !important;font-size:13px !important;margin:0 !important;';
